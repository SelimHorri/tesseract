...
class AsyncHttpClientsConfig {
	...
	@Bean
	TokenRetrieverAsyncClient tokenRetrieverAsyncClient(@Qualifier("zitadelWebClient") WebClient webClient) {
		return new DefaultTokenRetrieverAsyncClient(webClient);
	}
