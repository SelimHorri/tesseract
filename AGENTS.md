...
This file provides guidance to LLMs (claude, kimi, etc..) when working with code in this repository.
...
**Java 25** | **Spring Boot 3.5.14** | **Maven** | Published to Maven Central under `io.github.selimhorri`
